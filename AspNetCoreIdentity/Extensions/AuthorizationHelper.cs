...
namespace AspNetCoreIdentity.Extensions
{
    ...
    public class PermissaoNecessariaHandler : AuthorizationHandler<PermissaoNecessaria>
    {
        ...
        {
            if (context != null && requisito != null)
            {
                if (context.User.HasClaim(c => c.Type == "Permissao" && c.Value.Contains(requisito.Permissao, StringComparison.CurrentCultureIgnoreCase)))
                {
